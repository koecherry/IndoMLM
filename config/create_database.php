...
$query1 = mysqli_query($koneksi, "CREATE TABLE member
(
    ...
    PRIMARY KEY  (user_id)
)TYPE=MyISAM ") or error(mysqli_error());

$query2 = mysqli_query($koneksi, "CREATE TABLE news
(
    user_id SMALLINT UNSIGNED NOT NULL auto_increment,
...
echo "<p align=\"center\"><font size=\"4\">Selamat, Table database selesai dibuat ! </font></p>\n";
